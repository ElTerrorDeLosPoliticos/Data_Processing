...
def obtain_data_from_date(item_name):
    daily = pd.DataFrame()
    collection_name = ['Presidencia', 'Congreso']
    for institucion in collection_name:
        ...
        if booleano == True:
            ...
            #collection_name = [collection_name]*len(daily_inst)
...
if __name__ == '__main__':
    print("********************         LOADING VISITAS        ********************\n\n")
    global collection_name, month_dict
